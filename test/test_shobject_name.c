...
static bool valid_shobject_name(char* name_buf, char* actual_label, 
    ...
    snprintf(expected_name, MAX_NAME_SIZE, SHOBJ_NAME_FORMAT, 
        user, expected_label);   
    
    char* actual_name = shobject_name(name_buf, actual_label); 
...
MunitResult test_shobject_name_short(const MunitParameter params[], 
    ...
    assert_true(valid_shobject_name(buf, "test", NULL));
...
MunitResult test_shobject_name_empty(const MunitParameter params[], 
    void* fixture) {      
    char buf[MAX_NAME_SIZE];
    assert_true(valid_shobject_name(buf, "", NULL));
...
MunitResult test_shobject_name_char(const MunitParameter params[], 
    void* fixture) {      
    char buf[MAX_NAME_SIZE];
    assert_true(valid_shobject_name(buf, "a", NULL));
...
MunitResult test_shobject_name_long(const MunitParameter params[], 
    ...
    assert_true(valid_shobject_name(buf, 
...
MunitResult test_shobject_name_null(const MunitParameter params[], 
    void* fixture) {      
    char buf[MAX_NAME_SIZE];
    assert_true(valid_shobject_name(buf, NULL, NULL));
...
MunitResult test_shobject_name_long_heap(const MunitParameter params[], 
    ...
    assert_true(valid_shobject_name(NULL, 
        "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
        "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", 
        expected_label));  
